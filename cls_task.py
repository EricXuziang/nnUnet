...
def run_training_entry():
    ...
    parser.add_argument('dataset_name_or_id', type=str, default='001',
    ...
    parser.add_argument('-p', type=str, required=False, default='nnUNetResEncUNetMPlans',
...
if __name__ == '__main__':
    ...
    # python cls_task.py 001 3d_fullres 0
    run_training_entry()