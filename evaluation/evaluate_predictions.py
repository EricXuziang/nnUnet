...
if __name__ == '__main__':
    folder_ref = '/well/rittscher/users/ycr745/nnUNet/nnunetv2/dataset/nnUNet_raw/Dataset001_quiz/labelsVal'
    folder_pred = '//well/rittscher/users/ycr745/nnUNet/nnunetv2/results/val'
    output_file = '/well/rittscher/users/ycr745/nnUNet/nnunetv2/results/summary.json'
