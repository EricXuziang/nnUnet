...
from nnunetv2.multi_train import MultiScaleClassificationHead, MultiTaskModel
...
class nnUNetTrainer(object):
    ...
    def build_network_architecture(architecture_class_name: str,
        ...
        # model = MultiTaskModel(full_model, feature_dims=feature_dims, num_classes=3, dropout_rate=0.5)
